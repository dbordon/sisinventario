            ...
            //if($_GET['module']=="start"){ ?>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="?module=seccion"><i class="fa fa-circle-o"></i>Sección</a></li>
                        <li><a href="?module=estante"><i class="fa fa-circle-o"></i>Estante</a></li>
                ...
                <li class="treeview">
                   ...
                   <li class="treeview">
                    <a href="javascript:void(0);">
                        <i class="fa fa-certificate"></i><span>Informes</span><i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="?module=informes"><i class="fa fa-circle-o"></i>Informes con gráficos</a></li>
                    </ul>
                </li>
        ...
        <?php 
            //if($_GET['module']=="start"){ ?>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="?module=clientes"><i class="fa fa-circle-o"></i>Registrar clientes</a></li>
                    </ul>
                </li>
...
elseif($_SESSION['permisos_acceso']=='monitoreo'){?>
    <ul class="sidebar-menu">
           <li class="header">Menú</li>
               <?php 
                   if($_GET["module"]=="start"){
