                        ...
                        <div class="box-body">
                            ...
                            //Método para generar código
                                ...
                                if($count <> 0){
                                    ...
                                    $sql = "SELECT CONCAT('001-001-', LPAD(COUNT(*) + 1, 7, '0')) AS nro_factura_formateado FROM venta";

                                    $resultado = mysqli_query($mysqli, $sql);

                                    // Verificás si la consulta se ejecutó correctamente
                                    if ($resultado && mysqli_num_rows($resultado) > 0) {
                                        $fila = mysqli_fetch_assoc($resultado);
                                        $nro_factura = $fila['nro_factura_formateado'];
                                    } else {
                                        $nro_factura = '001-001-0000001'; // Valor por defecto si falla la consulta
                                }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    autocomplete="off" required>
                                        <option value=""></option>
                                        <?php 
                                            $query_prov = mysqli_query($mysqli, "SELECT *FROM clientes") or die ('Error'.mysqli_error($mysqli));
                                            while ($data_prov = mysqli_fetch_assoc($query_prov)){
                                                echo "<option value=\"$data_prov[id_cliente]\">$data_prov[cli_nombre] | $data_prov[cli_apellido] | $data_prov[ci_ruc]</option>";
                                            }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-3">
                                <input type="text" name="nro_factura" id="nro_factura" value="<?php echo $nro_factura; ?>" readonly>
