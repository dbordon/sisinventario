...
$sql = "SELECT prod.p_descrip AS producto, SUM(dtc.cantidad) AS cantidad_total
        FROM compra c
        INNER JOIN detalle_compra dtc ON c.cod_compra = dtc.cod_compra
...
<body>
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'Productos comprados en <?= addslashes($deposito) ?>'
        },
        subtitle: {
