<?php 
    if($_GET['form']=='add'){ ?>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="?module=u_medida"> Deposito</a></li>
                    ...
                    <form role="form" class="form-horizontal" action="modules/u_medida/proses.php?act=insert" method="POST">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="u_descrip" pleaceholder="Ingresa unidad de medida" required>
                                </div>
                            </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-footer">
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <input type="submit" class="btn btn-primary btn-submit" name="Guardar" value="Guardar">
                                        <a href="?module=u_medidas" class="btn btn-default btn-reset">Cancelar</a>
                                    </div>
                                </div>
                            </div>
