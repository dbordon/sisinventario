...
<h1>
    <i class="fa fa-folder icon-title"></i>Unidad de medida
                    ...
                    <table id="dataTables1" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               <div>
                               <a data-toggle='tooltip' data-placement='top' title='Modificar datos de Unidad de medida' style='margin-right:5px' 
