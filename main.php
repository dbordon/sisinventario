...
<html>
  <head>
    ...
    <meta name="description" content="Sistema - Proyecto Web">
    <meta name="author" content="Sistema - Proyecto Web - Dbordon" />
  ...
  <body class="skin-blue fixed" background="assets/img/fondo.jpg">
    <div class="wrapper">
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="#">UPAP - Proyecto Sistema Inventario</a></strong> <p><a href="https://wa.me/+595985887293" target="_blank"> by Sindy Jeannette Zárate Sosa</a></p>
      </footer>
    </div><!-- ./wrapper -->
